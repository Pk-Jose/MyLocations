...
class LocationDetailsViewController: UITableViewController {
  ...
  func string(from placemark: CLPlacemark) -> String {
    ...
    func format(date: Date) -> String { // formats date
...
extension LocationDetailsViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func takePhotoWithCamera() { // allows you to take a picture of your camera
    ...
    func choosePhotoFromLibrary() { // same thing as using camera, accept it goes to image picker
        let imagePicker = UIImagePickerController()
    ...
    func showPhotoMenu() { // choose between picking photo and using camera
